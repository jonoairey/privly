        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
            <div className="relative p-6 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow">
              ...
              <Link href="/event-tickets" className="text-indigo-600 font-medium hover:text-indigo-500">
                Learn more →
              </Link>
            </div>
            <div className="relative p-6 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow">
              ...
              <Link href="/access-control" className="text-indigo-600 font-medium hover:text-indigo-500">
                Learn more →
              </Link>
            </div>
          </div>
      ...
      <div className="bg-indigo-700">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="mt-8">
              <Link href="/contact" className="inline-flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-indigo-600 bg-white hover:bg-indigo-50">
                Contact Sales
              </Link>
            </div>
          </div>
